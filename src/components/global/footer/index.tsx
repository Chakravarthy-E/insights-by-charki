...
function Footer() {
  return (
    <footer className=" border-t py-6 flex flex-col lg:flex-row md:flex-row sm:flex-col xs:flex-col items-start justify-between space-y-6 lg:space-y-0 md:space-y-0 sm:space-y-6 font-outfit">
      <div className="lg:w-1/2 md:w-1/2 w-full">
        <p className="text-justify">
          ...
          kind of resource I wish I had when I first started out as a developer.
        </p>
      </div>
